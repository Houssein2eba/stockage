...
const tableHeaders = computed(() => [
    ...
    { label: 'Produits', field: 'products_count', sortable: true },
    ...
    <AuthLayout>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div class="flex flex-col md:flex-row items-start md:items-center justify-between mb-8 gap-4">
                <div>
                    <H1>Catégories</H1>
                    <P>Gérer vos catégories de produits</P>
                </div>
                <div class="flex items-center gap-4">
                    <div class="flex items-center gap-3 bg-blue-50/80 px-4 py-2 rounded-lg border border-blue-100">
                        ...
                        <span class="text-sm font-medium text-blue-800">
                            Total Catégories: <span class="font-semibold">{{ categories_count }}</span>
                        </span>
                    </div>
                    <Link
            ...
            <div class="bg-white rounded-lg border border-gray-200 shadow-xs m-auto">
                            ...
                            <TableRow v-if="categories.data.length === 0">
                                <TableDataCell colspan="4" class="px-4 sm:px-6 py-12">
                                    <div class="flex flex-col items-center justify-center">
                                        ...
                                        <p class="text-sm text-gray-400">Ajoutez votre première catégorie en utilisant le bouton créer ci-dessus</p>
                                    </div>
                                </TableDataCell>
                            </TableRow>
                        </template>
              ...
              <div class="text-sm text-gray-700" v-if="categories_count > 0">
                Affichage de <span class="font-medium">{{ categories.meta.from }}</span> à
                <span class="font-medium">{{ categories.meta.to }}</span> sur
                <span class="font-medium">{{ categories.meta.total }}</span> résultats
              </div>
                            ...
                            <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                                <div class="sm:flex sm:items-start">
                                    ...
                                    <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                        ...
                                        <div class="mt-2">
                                            <p class="text-sm text-gray-500">Êtes-vous sûr de vouloir supprimer cette catégorie ? Cette action ne peut pas être annulée.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div v-if="showEditModal" class="fixed inset-0 bg-gray-600 bg-opacity-50 flex items-center justify-center p-4 z-50">
                <div class="bg-white rounded-lg shadow-xl max-w-md w-full p-6">
                    ...
                    <form @submit.prevent="updateCategory">
                        <div class="mb-4">
                            <InputLabel for="edit-name" value="Nom" class="block text-sm font-medium text-gray-700 mb-1" />
                            <TextInput
                                id="edit-name"
                                type="text"
