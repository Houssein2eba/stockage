        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div class="mb-8 flex items-center justify-between">
                <div>
                    ...
                    <P>Ajouter un nouveau client à votre système</P>
                </div>
                <div>
                <Link
            ...
            <div >
                <div class=" bg-white rounded-xl shadow-lg p-8 text-gray-900 lg:w-1/2 sm:w-1/3 mx-auto">
                    <form @submit.prevent="submit" class="space-y-6 max-w-xl">
                        <div>
                            <InputLabel for="name" value="Nom du Client" class="mb-1.5" />
                            <TextInput
                                id="name"
                                type="text"
                                class="w-full"
                        ...
                        <div>
                            <InputLabel for="number" value="Numéro du Client" class="mb-1.5" />
                            <TextInput
                                id="number"
                                type="text"
                                class="w-full"
